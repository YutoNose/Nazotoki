...
export default function DiaryPage() {
  ...
  const [diaryEntries, setDiaryEntries] = useState<DiaryEntry[]>([
    ...
    },
    {
      date: "2024-08-21",
      content:
        "ボクの写真が日記に追加できたよ！写真がどこにあるかの設定が間違ってたみたい...",
    ...
    setDiaryEntries((prevEntries) => [
      {
        date: "2024-08-23",
        content:
          "今日、ページのデザインを大幅に変更したよ！シンプルでモダンな感じにしてみたんだ。色はあまり使わない方が、かっこいいデザインになるんだね。この調子でボクのページを増やしていきたいな。作ったゲームを紹介する/gameページを作ろうかな！ ...でも、まだテストだから、URLはその後に「test」をつけておこうっと。",
        image: "/images/new-design.png",
      },
      ...prevEntries,
    ]);
  };
